...
if (s === "так" || s === "ні" || s === "да" || s === "нет") return true;
return false;
}
...
const s = String(val).trim().toLowerCase();
if (s === "true" || s === "1" || s === "так" || s === "да") return "Так";
if (s === "false" || s === "0" || s === "ні" || s === "нет") return "Ні";
return "";
}
