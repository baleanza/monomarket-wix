...
// На основе вашего CURL примера: GET /ecom/v1/payments/orders/{orderId}
export async function getWixPaymentDetails(orderId) {
    try {
        ...
        // Wix может вернуть { payment: {...} } или { payments: [...] }
...
// На основе вашего CURL примера: update-payment-transaction-status -> VOIDED
