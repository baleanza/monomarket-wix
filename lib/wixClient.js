...
import { requireEnv } from './sheetsClient.js'; // ІМПОРТ ВИПРАВЛЕНО
...
// Функція повинна бути визначена в корені
...
// 1. Пошук товарів по SKU (для вебхука)
export async function getProductsBySkus(skus) {
  ...
  return allProducts.filter(p => {
    ...
    return targetSkus.includes(pSku);
  });
}
